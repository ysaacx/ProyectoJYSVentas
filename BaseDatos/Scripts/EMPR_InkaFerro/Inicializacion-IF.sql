...
UPDATE dbo.Sucursales SET SUCUR_Nombre = 'Sucursal Parusttacca', EMPRE_Codigo = 'IFERR', SUCUR_Direccion = 'PARUSTTACCA - CUSCO / CUSCO / SAN JERONIMO'
UPDATE dbo.Almacenes SET ALMAC_Descripcion = 'Almacen Parusttacca', ALMAC_Direccion = 'PARUSTTACCA - CUSCO / CUSCO / SAN JERONIMO'
UPDATE dbo.PuntoVenta SET PVENT_Descripcion = 'Punto de Parusttacca', PVENT_DireccionIP = 'SERVERIF\SQL12', PVENT_BaseDatos = 'BDInkasFerro', PVENT_BaseDatosAC = 'BDInkasFerro'
