...
delete FROM dbo.Lineas WHERE LINEA_Codigo LIKE '18%'

SELECT MAX(LINEA_Codigo) FROM dbo.Lineas
...
SELECT LINEA_Codigo ,LINEA_CodPadre ,TIPOS_CodTipoComision ,LINEA_Nombre ,
 ...
 FROM (
  ...
  UNION SELECT LINEA_Codigo = '1801' ,LINEA_CodPadre = '18',TIPOS_CodTipoComision = NULL ,LINEA_Nombre = 'Agua Simple Presión',LINEA_UsrCrea = 'SISTEMAS',LINEA_FecCrea = GETDATE()
 ...
 SELECT * FROM dbo.Lineas WHERE LINEA_CODIGO LIKE '14%'
 --SELECT * FROM dbo.Lineas ORDER BY linea_codigo
