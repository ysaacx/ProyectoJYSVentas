...
--UPDATE dbo.Aplicaciones SET APLI_BaseDatos = NULL WHERE APLI_BaseDatos IS NOT NULL  
 ...
 FROM (  SELECT EMPR_Codigo = @EMPR_Codigo   
              , EMPR_Desc = 'INKACERO PERU S.A.C.'         
              , EMPR_Direc = 'AV. AV DE LA CULTURA NRO. P6-1 URB. SANTA ROSA (PARADERO SANTA ROSA'
              , EMPR_RUC = '20609111268', EMPR_Servidor = @PVENT_DireccionIP          , EMPR_BaseDatos = 'BDInkaceroPeru'
...
-- =========================================================================================================== --
SELECT * INTO #PMenu FROM PlantillasMenu WHERE EMPR_Codigo = 'AFIRM' AND APLI_Codigo = 'VTA'
