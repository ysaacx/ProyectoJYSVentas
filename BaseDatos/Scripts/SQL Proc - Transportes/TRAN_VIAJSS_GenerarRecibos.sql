GO 
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[TRAN_VIAJSS_GenerarRecibos]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1) 
	DROP PROCEDURE [dbo].[TRAN_VIAJSS_GenerarRecibos] 
GO 
-- =============================================
...
-- Descripcion         : 
-- =============================================
CREATE PROCEDURE [dbo].[TRAN_VIAJSS_GenerarRecibos]
(
	@VIAJE_Id BigInt
)
As
...
Where Gas.VIAJE_Id = ISNULL(@VIAJE_Id, Gas.VIAJE_Id)
