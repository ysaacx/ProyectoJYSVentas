...
DECLARE @PVENT_BaseDatos VARCHAR(25) = 'BDCOMAFISUR'
...
DECLARE @EMPRE_Codigo VARCHAR(5) = 'FISUR'
...
DECLARE @SUCUR_Direccion VARCHAR(60) = 'MZA. L LOTE. 14 APV. TRES DE MAYO CUSCO - CUSCO - SAN JERONIMO'
DECLARE @PVENT_Direccion VARCHAR(200) = 'MZA. L LOTE. 14 APV. TRES DE MAYO (PSNDO GRIFO PETROROYAL ALT PDRO MIRAFLOR) CUSCO - CUSCO - SAN JERONIMO'
DECLARE @ALMAC_Direccion VARCHAR(120) = 'MZA. L LOTE. 14 APV. TRES DE MAYO (PSNDO GRIFO PETROROYAL ALT PDRO MIRAFLOR) CUSCO - CUSCO - SAN JERONIMO'

DECLARE @Empresaruc VARCHAR(20) = '20604039828'
DECLARE @EmpresaNombre VARCHAR(100) = 'COMAFISUR S.R.L.'
