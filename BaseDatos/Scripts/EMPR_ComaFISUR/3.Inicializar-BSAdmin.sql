...
--UPDATE dbo.Aplicaciones SET APLI_BaseDatos = NULL WHERE APLI_BaseDatos IS NOT NULL  
 ...
 FROM (  SELECT EMPR_Codigo = @EMPR_Codigo   
              , EMPR_Desc = 'COMAFISUR S.R.L.'         
              , EMPR_Direc = 'MZA. L LOTE. 14 APV. TRES DE MAYO SAN JERONIMO'
              , EMPR_RUC = '20604039828', EMPR_Servidor = @PVENT_DireccionIP          , EMPR_BaseDatos = 'BDCOMAFISUR'
