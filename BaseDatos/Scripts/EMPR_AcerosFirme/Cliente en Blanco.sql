...
ELSE
    BEGIN
        UPDATE [Entidades] SET ENTID_NroDocumento = '10000000000' WHERE ENTID_Codigo = '10000000000'
    END 
...
ELSE
    BEGIN
        UPDATE [Entidades] SET ENTID_NroDocumento = '10000000001' WHERE ENTID_Codigo = '10000000001'
    END 
...
ELSE
    BEGIN
        UPDATE [Entidades] SET ENTID_NroDocumento = '11000000' WHERE ENTID_Codigo = '11000000000'
    END 
...
UPDATE dbo.Entidades SET ENTID_RazonSocial = 'CLIENTE EN BLANCO' WHERE ENTID_Codigo = '11000000000'
...
SELECT * FROM EntidadesRoles Where ENTID_Codigo = '11000000000'
SELECT * FROM dbo.Clientes WHERE ENTID_Codigo = '11000000000'
SELECT * FROM dbo.Entidades WHERE ENTID_Codigo = '00000000000'
