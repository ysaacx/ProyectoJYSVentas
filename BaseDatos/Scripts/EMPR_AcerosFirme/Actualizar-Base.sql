...
DECLARE @PVENT_BaseDatos VARCHAR(25) = 'BDAcerosFirme'
DECLARE @SUCUR_Direccion VARCHAR(60) = 'AV. EVITAMIENTO NRO. A-8 APV. EL EDEN DE SANTA MARIA REYNA'
DECLARE @Empresaruc VARCHAR(20) = '20607790931'
DECLARE @EmpresaNombre VARCHAR(100) = 'ACEROS FIRME S.A.C.'
DECLARE @EMPRE_Codigo VARCHAR(5) = 'AFIRM'
