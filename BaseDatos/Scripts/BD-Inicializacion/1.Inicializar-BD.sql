...
--DECLARE @PVENT_BaseDatos VARCHAR(25) = 'BDJampSteph'
...
--DECLARE @EMPRE_Codigo VARCHAR(5) = 'JAMPS'
...
--DECLARE @SUCUR_Direccion VARCHAR(60) = 'Calle Mantaro227 Zamacola - Cerro Colorado'
--DECLARE @PVENT_Direccion VARCHAR(200) = @SUCUR_Direccion
--DECLARE @ALMAC_Direccion VARCHAR(120) = @SUCUR_Direccion

--DECLARE @Empresaruc VARCHAR(20) = '20558046300'
--DECLARE @EmpresaNombre VARCHAR(100) = 'JAMP & STEPH E.I.R.L.'
