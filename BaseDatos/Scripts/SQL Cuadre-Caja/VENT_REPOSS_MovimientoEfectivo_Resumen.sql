...
/* Ingreso de Efectivo Por Cancelaci√≥n de Documento de venta */
 SELECT TPag.TIPOS_DescCorta + ' ' + Right('000' + RTRIM(Doc.PVENT_Id), 3) + '-' + Right('0000000' + RTrim(Doc.DPAGO_Id), 7) As DocCaja
       ...
       , 'CancelaciÛn de Documento de Venta : '
...
--    ,Case Rec.TIPOS_CodTipoRecibo When 'CPDRE' Then 'Egreso en Efectivo Para Cancelaci√≥n de Documento' Else 'Ingreso en Efectivo' End + '  / Responsable: ' 
