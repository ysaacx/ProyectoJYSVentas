--use BDDACEROSLAM
--USE BDInkaPeru
--SP_HELPTEXT CTRL_STOCKSS_KardexXArticulo
GO 
...
Begin
	Set @Stock  = @Stock + (Select top 1 Ingreso - Salida From #Kardex Where STOCK_Id = @STOCK_Id)
...
exec CTRL_STOCKSS_KardexXArticulo @ARTIC_Codigo=N'0401029',@ALMAC_Id=1,@PERIO_Codigo=N'2019',@ZONAS_Codigo=N'84.00',@FecIni='2019-01-01 00:00:00',@FecFin='2019-12-31 00:00:00'

--exec CTRL_STOCKSS_KardexXArticulo @ARTIC_Codigo=N'0103003',@ALMAC_Id=1,@PERIO_Codigo=N'2019',@ZONAS_Codigo=N'84.00',@FecIni='2019-09-01 00:00:00',@FecFin='2019-10-01 00:00:00'
--exec CTRL_STOCKSS_KardexXArticulo @ARTIC_Codigo=N'0103003',@ALMAC_Id=1,@PERIO_Codigo=N'2019',@ZONAS_Codigo=N'84.00',@FecIni='2019-10-01 00:00:00',@FecFin='2019-10-01 00:00:00'
