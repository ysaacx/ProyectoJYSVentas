USE BDSisSCC
GO 
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[LOG_STOCKSS_ObtenerStockAlmacen]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1) 
	DROP PROCEDURE [dbo].[LOG_STOCKSS_ObtenerStockAlmacen] 
GO 
-- =============================================
...
-- Descripcion         : 
-- =============================================
CREATE PROCEDURE [dbo].[LOG_STOCKSS_ObtenerStockAlmacen]
(
...
GO 
/***************************************************************************************************************************************/ 
--exec LOG_STOCKSS_ObtenerStockAlmacen @PERIO_Codigo=N'2017',@ARTIC_Codigo=N'0101001',@ALMAC_Id=1,@ZONAS_Codigo=N'54.00'
...
--exec LOG_STOCKSS_ObtenerStockAlmacen @PERIO_Codigo=N'2016',@ARTIC_Codigo=N'0101001',@ALMAC_Id=1,@ZONAS_Codigo=N'54.00'
exec LOG_STOCKSS_ObtenerStockAlmacen @PERIO_Codigo=N'2017',@ARTIC_Codigo=N'1201001',@ALMAC_Id=1,@ZONAS_Codigo=N'83.00'
