...
DECLARE @ZONAS_Codigo CHAR(5) = '54.00'
...
DECLARE @PVENT_BaseDatos VARCHAR(25) = 'BDJMMS1'
...
DECLARE @EMPRE_Codigo VARCHAR(5) = 'DJMMS'
...
DECLARE @SUCUR_Direccion VARCHAR(60) = 'CALLE ANDIA 104 MM - AREQUIPA / AREQUIPA / MARIANO MELGAR'
DECLARE @PVENT_Direccion VARCHAR(200) = 'CALLE ANDIA 104 MM - AREQUIPA / AREQUIPA / MARIANO MELGAR'
DECLARE @ALMAC_Direccion VARCHAR(120) = 'CALLE ANDIA 104 MM - AREQUIPA / AREQUIPA / MARIANO MELGAR'

DECLARE @Empresaruc VARCHAR(20) = '20434873887'
DECLARE @EmpresaNombre VARCHAR(100) = 'J&M MATERIALES Y SERVICIOS SAC'
