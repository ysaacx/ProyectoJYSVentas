...
DECLARE @PVENT_BaseDatos VARCHAR(25) = 'BDDakaConsultores'
DECLARE @SUCUR_Direccion VARCHAR(60) = 'CAL.ALEJANDRO VELASCO ASTETE NRO. 606'
DECLARE @Empresaruc VARCHAR(20) = '20607790931'
DECLARE @EmpresaNombre VARCHAR(100) = 'DAKA CONSULTORES & EJECUTORES EIRL'
DECLARE @EMPRE_Codigo VARCHAR(5) = 'DAKAC'
DECLARE @PVENT_DireccionIP VARCHAR(25) = 'SERVERDAKA\SQL12'
...
UPDATE dbo.Periodos SET PERIO_Codigo = '2022', PERIO_Descripcion = 'Periodo 2022' WHERE PERIO_Codigo = 2021
