GO 
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[REPOSS_GuiasXConductor]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1) 
	DROP PROCEDURE [dbo].[REPOSS_GuiasXConductor] 
GO 
-- =============================================
...
-- Descripcion         : 
-- =============================================
CREATE PROCEDURE [dbo].[REPOSS_GuiasXConductor]
	 @FecIni DateTime
	,@FecFin DateTime
	,@Licencia_Conducir VarChar(10)
AS
...
Where Cond.CONDU_Licencia = @Licencia_Conducir
